...
export interface IFHEVMCoprocessorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cast"
...
export interface IFHEVMCoprocessor extends BaseContract {
  connect(runner?: ContractRunner | null): IFHEVMCoprocessor;
  waitForDeployment(): Promise<this>;

  interface: IFHEVMCoprocessorInterface;

...
export interface MockedPrecompileInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cast"
      | "counterRand"
...
export interface MockedPrecompile extends BaseContract {
  connect(runner?: ContractRunner | null): MockedPrecompile;
  waitForDeployment(): Promise<this>;

  interface: MockedPrecompileInterface;
  ...
  counterRand: TypedContractMethod<[], [bigint], "view">;
  ...
  fheRand: TypedContractMethod<
    [randType: BytesLike, arg1: BigNumberish],
    [bigint],
    "nonpayable"
  >;

  fheRandBounded: TypedContractMethod<
    [upperBound: BigNumberish, randType: BytesLike, arg2: BigNumberish],
    [bigint],
    "nonpayable"
  >;
